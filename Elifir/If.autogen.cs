namespace Nuisho.Elifir
{
    public static partial class Syntax
    {
        ...
        public static ((ꞏꞏꞏ, Іf<I>.Is<Iʹ>), Іf<Iʹ>) If<I, ꞏꞏꞏ, Iʹ>(
            this (ꞏꞏꞏ, Іf<I>.Is<Iʹ>) o,
            Func<Iʹ, bool> condition)
                where Iʹ : I =>
                (o, If(condition));
        
        public static ((ꞏꞏꞏ, Іf<I>.Is<Iʹ>), Іf<Iʹ>.Is<Iʺ>) If<I, ꞏꞏꞏ, Iʹ, Iʺ>(
            this (ꞏꞏꞏ, Іf<I>.Is<Iʹ>) o,
            IsOfType<Iʺ> condition)
                where Iʹ : I
                where Iʺ : Iʹ =>
        ...
        public static ((ꞏꞏꞏ, Іf<I>.Then<T>), Іf<T>) If<I, ꞏꞏꞏ, T>(
            this (ꞏꞏꞏ, Іf<I>.Then<T>) o,
            Func<T, bool> condition) =>
                (o, If(condition));
        
        public static ((ꞏꞏꞏ, Іf<I>.Then<T>), Іf<T>.Is<Tʹ>) If<I, ꞏꞏꞏ, T, Tʹ>(
            this (ꞏꞏꞏ, Іf<I>.Then<T>) o,
            IsOfType<Tʹ> condition)
                where Tʹ : T =>
                    (o, new());
        ...
        public static ((ꞏꞏꞏ, Іf<I>.Then<T>.Else), Іf<I>) If<I, T, ꞏꞏꞏ>(
            this (ꞏꞏꞏ, Іf<I>.Then<T>.Else) o,
            Func<I, bool> condition) =>
                (o, If(condition));
        
        public static ((ꞏꞏꞏ, Іf<I>.Then<T>.Else), Іf<I>.Is<Iʹ>) If<I, T, ꞏꞏꞏ, Iʹ>(
            this (ꞏꞏꞏ, Іf<I>.Then<T>.Else) o,
            IsOfType<Iʹ> condition)
                where Iʹ : I =>
                    (o, new());
        ...
        public static ((ꞏꞏꞏ, Іf<I>.Then<T>.Else.Then<E>), Іf<E>) If<I, T, ꞏꞏꞏ, E>(
            this (ꞏꞏꞏ, Іf<I>.Then<T>.Else.Then<E>) o,
            Func<E, bool> condition) =>
                (o, If(condition));
        
        public static ((ꞏꞏꞏ, Іf<I>.Then<T>.Else.Then<E>), Іf<E>.Is<Eʹ>) If<I, T, ꞏꞏꞏ, E, Eʹ>(
            this (ꞏꞏꞏ, Іf<I>.Then<T>.Else.Then<E>) o,
            IsOfType<Eʹ> condition)
                where Eʹ : E =>
                    (o, new());
