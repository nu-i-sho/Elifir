    ...
    public class FuncIfThenManualEndTest
    {
        ...
        public int Test_0425(bool firstIsΔΔ, bool secondIsΛΛΛ)
        {
            ...
            var f =                                                 
                ...
                .If(Object<Δ>.Is<ΔΔ>)                               // (false, true, 25) -> 136
        ...
        public int Test_0426(bool firstIsΔΔ, bool secondIsΛΛΛ)
        {
            ...
            var f =                                             
                ...
                .If(Object<Δ>.Is<ΔΔ>)                           // (false, true, 3) -> 113
